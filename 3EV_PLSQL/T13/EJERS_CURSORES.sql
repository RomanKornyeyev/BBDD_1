...
IS
	CURSOR C1 IS SELECT DNOMBRE, COUNT(EMP_NO) AS NUM_EMPLES FROM DEPART D, EMPLE E WHERE D.DEPT_NO=E.DEPT_NO GROUP BY DNOMBRE;
BEGIN
	FOR I IN C1 LOOP
		DBMS_OUTPUT.PUT_LINE(I.DNOMBRE||'*'||I.NUM_EMPLES);
	END LOOP;
END;
/
