...
create table fabricante(
  ...
  nombre varchar2(25),
  pais   varchar2(30));
drop table programa cascade constraint;
create table programa(
  codigo number primary key,
  nombre varchar2(25),
  version varchar2(25));
drop table comercio cascade constraint;
...
create table cliente(
  ...
  nombre varchar2(25),
  edad number);
drop table desarrolla cascade constraint;
create table desarrolla(
  id_fab number,
  codigo number,
  primary key(id_fab,codigo));
drop table distribuye cascade constraint;
create table distribuye(
  cif number,
  codigo number,
  cantidad number,
  primary key(cif,codigo));
drop table registra cascade constraint;
