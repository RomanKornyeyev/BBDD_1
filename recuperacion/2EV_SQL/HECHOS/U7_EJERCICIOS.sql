...
ALTER TABLE PROYECTO DROP CONSTRAINT UNICO; /*SOLUCIÓN PROFE*/

/* Comprobar que el salario (campo añadido en alters) esté entre 965 y 3000*/
ALTER TABLE EMPLEADO ADD CONSTRAINT LIM_SALARIO CHECK(SALARIO BETWEEN 965 AND 3000);

/* Impedir que se puedan insertar nombres en minúscula en EMPLEADO */
ALTER TABLE EMPLEADO ADD CONSTRAINT NOM_MAYUS CHECK(NOMBRE=UPPER(NOMBRE));
...
/*EL ÚLTIMO CAMPO DE EMPLEADO ES EL SUELDO (QUE NO ESTÁ AL CREAR LA TABLA, PERO QUE AÑADIMOS CON UN ALTER DESPUÉS)*/
INSERT INTO EMPLEADO VALUES('0001-E', '12312Z', 'ROMAN', 'CALLE SOL', 28038, 'MADRID', '0001-D', 2000);
